...
# from Model_Transformer.utils import *
...
# model = load_model('ckpts/transformer.pkl')
# text = "Privilege Escalation"

# nlp = spacy.load('/workspace/Py4CSKG/data/v3/output/model-best')
...
raw_inputs = [
    ...
    "I hate this so much!",
    "uncontrolled search path element privilege escalation escalate privileges"
]
inputs = tokenizer(raw_inputs, padding=True, truncation=True, return_tensors="pt")
y = model(inputs.data['input_ids'])
print(1)
